...
.mobile-menu {
    ...
    background-color: ; /* Cor de fundo do menu móvel */
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const depositButton = document.querySelector(".depositar-btn");
    ...
    menuButton.addEventListener("click", function() {
        if (mobileMenu.style.display === "none" || mobileMenu.style.display === "") {
            ...
            depositButton.style.display = "flex";
        }
    });
});
</script>
...
<div class="postForm">
    ...
    <div>
        ...
        <input type="button" value="Depositar" class="primary-button w-button submitBtn" style="background-color: #00FF00 !important;" onclick="irPara('../deposito')"><br><br>
    </div>
