...
<head>
    ...
    <title>Subway - Taxa de Saque</title>
    <meta name="description" content="Taxa de Saque Subway">
...
<body class="container-fluid">
    ...
    <main class="row my-2">
        <div class="col-sm-12 px-2 col-md-9 ">
            ...
            <img src="https://i.postimg.cc/3RLpLGx7/bannertaxa1.png"
                ...
                <div class="card-body m-0">
                    <div class="icon-detalhes">
                        ...
                        <div class="icon-detalhes-text">
                            ...
                            <p class="marginless">Taxa de saque (fila de Prioridade) <br> R$ 47,00</p>
                        </div>
                    </div>
                </div>
            </div>
