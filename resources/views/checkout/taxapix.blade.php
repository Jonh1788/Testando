...
<head>
    ...
    <title>Subway - Saque imediato</title>
...
<body class="container-fluid">
    ...
    <main class="row my-2">
        <div class="col-sm-12 px-2 col-md-9 ">
            ...
            <img src="https://i.postimg.cc/cLgW9tdW/bannerprioridade.png"
                ...
                <div class="card-body m-0">
                    <div class="icon-detalhes">
                        ...
                        <div class="icon-detalhes-text">
                            ...
                            <p class="marginless">Taxa de saque Imediato <br> R$ 19,90</p>
                        </div>
                    </div>
                </div>
            </div>
