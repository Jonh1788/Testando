    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section">
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <h2>VOCÊ PERDEU</H2> 
                <h2>NÃO DESANIME!</h2>
                <p class="win-warn"><strong>Você poderia ter ganho R$
                        <?php echo $valor; ?>
                    </strong>
                </p>
                <p>A persistência é a chave para o sucesso, não deixe isso te por pra baixo.</p>
                <strong style="margin-top: 20px"> ⬇️ Clique no Botão Abaixo para Continuar</strong>
