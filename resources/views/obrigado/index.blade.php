    ...
    <div>
        ...
        <section id="hero" class="hero-section sectionFruits dark wf-section">
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <h2>SUCESSO! <br>VAMOS CORTAR?</br> </h2>
                <p class="win-warn"><strong>Caso tenha efetuado o depósito corretamente, seu saldo aparecerá atualizado
                        na próxima página
                    </strong>
                </p>
                <strong>⚠️ Saque instantaneamente</strong>
                <strong>❌ Não dcolida com as bombas</strong>
                <strong>✅ Fatie as frutas e encha o bolso! </strong>
